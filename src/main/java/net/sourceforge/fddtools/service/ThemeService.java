...
public final class ThemeService {
    ...
    public void applyTheme(Theme theme) {
        Platform.runLater(() -> {
            ...
            // Always ensure semantic base is present once
            var semantic = getClass().getResource("/styles/semantic-theme.css");
            if(semantic!=null){ String u=semantic.toExternalForm(); if(!scene.getStylesheets().contains(u)) scene.getStylesheets().add(0,u);} // add at front so variants can override
